...
export default function AppLayout({ children }: { children: React.ReactNode }) {
  ...
  // Don't show nav on landing page or auth
    ...
    <div className="min-h-screen bg-background flex flex-col md:flex-row">
      ...
      {isSidebarOpen && (
        <div className="fixed inset-0 z-40 bg-black/50 md:hidden" onClick={() => setIsSidebarOpen(false)}>
          <div className="absolute left-0 top-0 bottom-0 w-3/4 bg-white p-6 flex flex-col gap-4 animate-in slide-in-from-left duration-300" onClick={e => e.stopPropagation()}>
